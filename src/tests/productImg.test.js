...
test("POST -> 'URL_BASE', should status code 201 and res.body.url to be defined and rs.body.file to be defined", async ()=>{
...
test("DELETE -> 'URL_BASE/:id', should status code 204 and res.body.length === 1", async ()=>{
